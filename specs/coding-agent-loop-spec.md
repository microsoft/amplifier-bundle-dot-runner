...
baseline note in `docs/SPEC_CONFORMANCE_HISTORY.md`). Rather than reconstruct which edits were deliberate,
...
and dispositioned in `docs/SPEC_CONFORMANCE_HISTORY.md` (`CAL-*` rows).
