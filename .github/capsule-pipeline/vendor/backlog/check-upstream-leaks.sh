...
# (path: .github/capsule-pipeline/vendor/backlog/check-upstream-leaks.sh), that repo's main tip at re-sync time (2026-08-29).
...
# changes).
#
# NOTE: this file already carries an inner VENDORED COPY box (its own
# sync from a private working repo) immediately below -- that inner box
# is untouched, part of the byte-identical body this outer box guards.
# ==============================================================================
# ============================================================================
